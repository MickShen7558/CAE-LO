...
strBaseDir = os.path.join(Disk_F,'kitti_velodyne')
str3DFeatNetDir = os.path.join(Disk_F,'KITTI_odometry', 'output_3DFeatNet');
strUsipBaseDir =   os.path.join(Disk_F, 'USIP')


strGroundTruthPosesDir = os.path.join(strBaseDir, 'data_odometry_poses')
...
strDataBaseDir = os.path.join(strBaseDir, 'data_odometry_velodyne', 'dataset' ,'sequences')
strCalibDataDir = os.path.join(strBaseDir, 'data_odometry_calib')
